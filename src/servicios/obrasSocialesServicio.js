...
export default class ObrasSocialesServicio {
  ...
  actualizar = (id_obra_social, nombre, descripcion, porcentaje_descuento, es_particular) => {
    return this.obrasSociales.actualizar(id_obra_social, nombre, descripcion, porcentaje_descuento, es_particular);
  };
